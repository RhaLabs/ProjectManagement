 ...
 * @ORM\Entity(repositoryClass="LimeTrail\Bundle\Repository\ContactRepository")
 */
class Contact
{
    /**
     ...
     */
    private $office;
    public function addOffice(\LimeTrail\Bundle\Entity\Office $office)
    {
     ...
     */
    private $projects;
    public function addProject(\LimeTrail\Bundle\Entity\ProjectContacts $projects)
    {
    ...
    public function addAorContact(\LimeTrail\Bundle\Entity\ProjectInformation $Type)
    {
     ...
     * Set company
     *
     * @param  \LimeTrail\Bundle\Entity\Company $company
     * @return Contact
     */
    public function setCompany(\LimeTrail\Bundle\Entity\Office $office)
    {
        $this->offuce = $office;
     ...
     * Get company
     *
     * @return \LimeTrail\Bundle\Entity\Company
     */
     ...
     * Remove aorContact
     */
    public function removeAorContact(\LimeTrail\Bundle\Entity\ProjectInformation $contact)
    {
