...
{
    const IDENTIFIER = 'project_change';
    protected $factory;
    ...
    { /* https://github.com/thrace-project/datagrid-bundle/blob/master/Resources/doc/index.md#installation */
        ...
        $dataGrid
            ...
            ->setCaption($this->translator->trans('Project Change Initiations'))
    ...
    {
        $qb = $this->em->getRepository('LimeTrailBundle:ProjectChangeInitiation')->createQueryBuilder('pci');
